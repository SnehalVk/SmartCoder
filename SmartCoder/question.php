                    ...
                    <body ng-controller="bzCtrl">
                        <nav class="navbar navbar-default navbar-fixed-top" style="background-color:white;border:color:#428BCA;">
                            ...
                            <div class="navbar-header">
                                ...
                                <!-- <a class="navbar-brand" style="color:#428BCA; font-size:25px; font-family:Times New Roman;border-color:#428BCA" href="#">CODEX</a> -->
                            </div>
                        </nav>
                        <br/>
                        <br/>
                                    ...
                                    <div id="wrapper">
                                        ...
                                        <div id="login" class="animate form">
                                            ...
                                            <div class="container-fluid">
                                                <h4 style="color:#428BCA;">Select a question below to answer.</h4> <br>
                                                <?php
