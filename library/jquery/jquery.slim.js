...
// Return a library-prefixed property or undefined
function libraryPropName( name ) {
...
// Return a potentially-mapped jQuery.cssProps or library prefixed property
function finalPropName( name ) {
	var final = jQuery.cssProps[ name ] || libraryProps[ name ];
	...
	return libraryProps[ name ] = libraryPropName( name ) || name;
}
